...
ax1 = sns.distplot(piam20241["DERECHOS_MATRICULA"], hist=False, color="r", label="Derechos de Matrícula")
sns.distplot(piam20241["Predicciones"], hist=False, color="b", label="Predicciones", ax=ax1)
